...
{
	internal class RegistryDocumentationHandlerGL2 : RegistryDocumentationHandlerDefault
	{
		#region Constructors
		...
		/// Static constructor.
		/// </summary>
		static RegistryDocumentationHandlerGL2()
		{
		...
		public override void Load(string xmlPath)
		{
			...
			using (FileStream fs = new FileStream(xmlPath, FileMode.Open, FileAccess.Read)) {
				XmlReaderSettings xmlReaderSettings = new XmlReaderSettings
				{
					...
					XmlResolver = new LocalXhtmlXmlResolver(Path.Combine(Program.BasePath, "RefPages/DTD"))
				};
